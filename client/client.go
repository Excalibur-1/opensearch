// Package client This file is auto-generated, don't edit it. Thanks.
package client
...
func (client *Client) Request(method *string, pathname *string, query map[string]interface{}, headers map[string]*string, body interface{}, runtime *util.RuntimeOptions) (_result string, _err error) {
	...
	for _retryTimes := 0; tea.BoolValue(tea.AllowRetry(_runtime["retry"], tea.Int(_retryTimes))); _retryTimes++ {
		...
		_resp, _err = func() (string, error) {
			...
			request_.Headers["Authorization"] = GetSignature(request_, accesskeyId, accessKeySecret)
			...
			_err = tea.Convert(objStr, &_result)
			return _result, _err
		}()
